...
public interface GraphService {
     ...
     * Query graph detail by get graph detail request
     *
     * @param request  graph config info request
     * @return graph detail view object
     */
    void saveGraphConfig(SaveGraphConfigRequest request);

    /**
     * Query graph fc detail by get graph detail request
     *
     * @param request  graph config info request
     * @return graph detail view object
     */
    JSONObject graphFcConfigDetail(GetGraphRequest request);
