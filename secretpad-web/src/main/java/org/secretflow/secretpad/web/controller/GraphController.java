...
public class GraphController {
    ...
    /**
     * graph save/config api
     *
     * @param request get graph save/config request
     * @return successful SecretPadResponse with graph save/config view object
     */
    @Operation(summary = "graph save/config")
    @PostMapping("/graph/save/config")
    @DataResource(field = "projectId", resourceType = DataResourceTypeEnum.PROJECT_ID)
    @ApiResource(code = ApiResourceCodeConstants.GRAPH_DETAIL)
    public SecretPadResponse saveGraphConfig(@Valid @RequestBody SaveGraphConfigRequest request) {
        graphService.saveGraphConfig(request);
        return SecretPadResponse.success();
    }
     ...
     * graph save/config api
     *
     * @param request get graph fc_detail request
     * @return successful SecretPadResponse with graph fc_detail view object
     */
    @Operation(summary = "graph fc_detail")
    @PostMapping("/graph/fc_detail")
    @DataResource(field = "projectId", resourceType = DataResourceTypeEnum.PROJECT_ID)
    @ApiResource(code = ApiResourceCodeConstants.GRAPH_DETAIL)
    public SecretPadResponse<JSONObject> graphFcConfigDetail(@Valid @RequestBody GetGraphRequest request) {
        return SecretPadResponse.success(graphService.graphFcConfigDetail(request));
    }
